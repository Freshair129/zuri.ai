...
// @req FR-158 — one sales order. GET reads it with its lines, its payments and
...
// @tested tests/unit/commerce-routes.test.js, tests/integration/fr158-sales-order.test.js

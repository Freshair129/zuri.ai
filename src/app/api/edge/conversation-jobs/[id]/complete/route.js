...
import { completeEdgeConversation } from '@/modules/line-oa-studio/application/line-conversation-jobs'
...
export async function POST(request, { params } = {}) {
  try {
    ...
    const result = await completeEdgeConversation(params?.id, body, { deviceContext })

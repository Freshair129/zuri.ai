...
// a Project or Workstream scope before the unscoped read runs.
...
export async function GET(request) {
  return handle(async () => {
    ...
    return listMilestonesAndGates({ projectId: q.projectId || undefined, workstreamId: q.workstreamId || undefined })
  })
}

...
export default function ManagedFilesPanel({ businessId, projectId = null, businessTools = false }) {
  ...
  return <>
    ...
    {!assets.length ? <EmptyState title="No managed files" hint="Add a Business or Project file. Local content requires a configured device mount." /> : <div className="grid gap-3 md:grid-cols-2">

...
// @req FR-160, FR-161 — Procurement (ADR-066), the buy side. A supplier is
...
// line, CLOSED is a short-close of a SENT order with lines still outstanding,
...
export const PURCHASE_ORDER_STATUSES = ['DRAFT', 'SENT', 'RECEIVED', 'CLOSED', 'CANCELLED']

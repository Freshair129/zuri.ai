-- @req FR-023 — tenant-partition the LINE conversation/message external id namespace.
-- @spec BR-001, BR-002, SEC-001 — Tenant is the isolation boundary and an external id
-- is envelope data, never a key.

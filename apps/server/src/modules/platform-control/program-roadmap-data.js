...
export const PROGRAMME_PHASES = [
  ...
  { id: 'PHASE-ZAI-03', start: '2026-10-19', end: '2026-11-15', weeks: 'W9–12', dates: '19 Oct – 15 Nov 2026', status: 'in-progress', progress: 15, goal: 'Second Business, governed analytics, workflows and connectors; deliverable 11 accepted; the Context Composer, LINE grounding from the published corpus, reviewed knowledge candidates, and memory policy with erasure once MSP can erase', sprints: [
    { id: 'SPR-ZAI-05', start: '2026-10-19', end: '2026-11-01', weeks: 'W9–10', dates: '19 Oct – 1 Nov', status: 'in-progress', progress: 32, goal: 'Business template, onboarding and isolation proof; the Context Composer and LINE corpus grounding with its isolated acceptance' },
...
export const PROGRAMME_TASKS = [
  ...
  ['TASK-ZAI-112', 'SPR-ZAI-05', 'Chat evidence retrieval, FR-245 — an OWNER at AAL2 retrieves one Customer\'s archived messages for a date range by session with a case reference, as an export carrying file and manifest hashes, audited', 'FR', 'C-2', 'H3', 'done'],

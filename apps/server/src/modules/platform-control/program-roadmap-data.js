...
const PROGRAMME_TASK_DEFINITIONS = [
  ...
  ['TASK-ZAI-114', 'SPR-ZAI-06', 'Chat evidence archive on production — the cold-archive compose overlay on F:, ZURI_ARCHIVE_KEK with its offline backup, the migrations applied under ADR-057, the sweep token and 03:00 scheduled task, and the first recorded manifest', 'NFR', 'C-2', 'H4', 'review'],

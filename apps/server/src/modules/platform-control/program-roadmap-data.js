...
export const PROGRAMME_PHASES = [
  { id: 'PHASE-ZAI-01', weeks: 'W1–4', dates: '24 Aug – 20 Sep 2026', status: 'in-progress', progress: 73, goal: 'Consolidate the inherited foundation into a production-grade base; land the ERP business modules for Business one; open the SmartGift cost and quote engine on the owner\'s instruction', sprints: [
...
export const PROGRAMME_TASKS = [
  ...
  ['TASK-ZAI-060', 'SPR-ZAI-02', 'Data pipeline map decision record — the ADR for a Knowledge (GKS) navigation slot that consumes GKS without becoming it, and the requirement and FEAT declarations', 'NFR', 'C-2', 'H2', 'in-progress'],
  ['TASK-ZAI-061', 'SPR-ZAI-02', 'Data pipeline registry — the written map of inbound sources, outbound recipients and combine chains, a validated JSON registry, a generated runtime projection and a preflight check', 'FR', 'C-3', 'H3', 'planned'],
  ['TASK-ZAI-062', 'SPR-ZAI-02', 'Data Pipeline Map node-edge view under the Knowledge (GKS) slot — layered graph, chain, domain and status filters, edge detail with domain, FEAT and surface level, and a list view', 'FR', 'C-3', 'H3', 'planned'],

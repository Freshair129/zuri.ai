...
export const PROGRAMME_TASKS = [
  ...
  ['TASK-ZAI-107', 'SPR-ZAI-03', 'Sessions on the LINE job, trace and inbox, FR-243 — the session id on LineConversationJob, a trace filter by session, a divider between sessions in the inbox, and the account setting for the idle timeout', 'FR', 'C-2', 'H2', 'review'],

// @req FR-139 — bounded one-way Google Sheets snapshot preview.
...
import { convertAssetSheetSnapshot } from '@/modules/asset-management/import/sheet-snapshot'
...
export async function POST(request) {
  return handle(async () => {
    ...
    return convertAssetSheetSnapshot(body)
  })
}

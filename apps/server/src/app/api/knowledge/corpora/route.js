...
import { listConsoleCorpora } from '@/modules/knowledge/knowledge-console-service'

export const dynamic = 'force-dynamic'
export async function GET(request) {
  return consoleRequest(request, async (options) => listConsoleCorpora(consoleParameters(request), options))
}

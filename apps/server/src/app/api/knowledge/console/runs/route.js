...
import { listConsoleRuns } from '@/modules/knowledge/knowledge-console-service'

export const dynamic = 'force-dynamic'
export async function GET(request) {
  return consoleRequest(request, async (options) => listConsoleRuns(consoleParameters(request), options))
}

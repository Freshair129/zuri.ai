...
// @req FR-252 — graph allocation replaces named Feature link sets atomically,
// with exact affected WorkItem membership and a Project graph ETag.
...
export async function PUT(request, { params }) {
  ...
  try {
    ...
    const result = await redistributeProjectFeatureWorkLinks(projectId, () => readJson(request), {
      viewer,
      session,
      requestId,

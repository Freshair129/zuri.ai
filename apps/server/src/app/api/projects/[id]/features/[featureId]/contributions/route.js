...
// @req FR-252 — a complete supporting-Domain contribution replacement is
// owner-authorized, bounded, CAS-protected and atomically audited.
...
export async function PUT(request, { params }) {
  ...
  try {
    ...
    const result = await replaceProjectFeatureContributions(projectId, featureId, () => readJson(request), {
      viewer,
      session,
      requestId,

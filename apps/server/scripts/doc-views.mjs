...
export function domainMap(nodes, edges) {
  ...
  return (
    ...
    // DOMAIN-MAP is inlined into llms-full.txt, and a reader who lands on it directly
    // has no other path to the corpus: a hand-written pointer would be overwritten by
    // the next `docs:graph`, so the generator emits it.

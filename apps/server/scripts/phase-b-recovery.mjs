...
const FROZEN_SCHEMA_SHA256 = '9bc8c777e00f7716b94b99a6a771e1453b9d667d887bcb2ed0118779ca0ec2be'
const FROZEN_TARGET_SCHEMA_SHA256 = '617b091c8b94ff306f9b98989676f631360b23f4a7faac0f1e57d16743999f5b'
const FROZEN_APPLICATION_TABLE_COUNT = 175
...
function normalizeInventory(inventory) {
  ...
  if (!pinned || modelNames.size !== FROZEN_APPLICATION_TABLE_COUNT || tableNames.size !== FROZEN_APPLICATION_TABLE_COUNT) {
    throw new PhaseBRecoveryError(PHASE_B_ERROR_CODES.TARGET_SCHEMA_UNVERIFIED, 'Frozen application table inventory is not the approved 175-table inventory')
  }
  return normalized
}

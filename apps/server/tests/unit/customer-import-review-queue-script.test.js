...
const manifest = JSON.parse(fs.readFileSync(workspacePath(process.cwd(), 'artifacts/migrations/MIS-SG-CUSTOMER-DATA-BACKFILL-001/customer-review-queue-manifest.json'), 'utf8'))

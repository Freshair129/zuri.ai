...
describe('Marketing Postgres migration security', () => {
  it.each([['20260906200000_marketing_strategy.sql', 5], ['20260906220000_marketing_campaigns.sql', 1], ['20260906234000_marketing_content.sql', 4]])('gives every table in %s a private runtime policy', (file, count) => {

...
const mocks = vi.hoisted(() => ({ ports: vi.fn(), answer: vi.fn(), tick: vi.fn(), reconcile: vi.fn(), health: vi.fn() }))
...
vi.mock('@/modules/line-oa-studio/application/line-transport-health-schedule', () => ({ runDueLineTransportHealth: mocks.health }))
...
beforeEach(() => {
  ...
  mocks.health.mockResolvedValue({ status: 'NOT_DUE', ran: false })
})

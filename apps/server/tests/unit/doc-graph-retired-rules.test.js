...
const graph = () => JSON.parse(readFileSync(workspacePath(process.cwd(), 'docs/.doc-graph.json'), 'utf8'))
const registry = () => readFileSync(workspacePath(process.cwd(), 'docs/PRD-SDD-v1.0.md'), 'utf8')

// @req FR-166, FR-163 — what the commerce routes and persistence are, in
...
describe('FR-166 / FR-163 commerce route and persistence contract', () => {
  it('every handler exposes exactly its inventoried methods, resolves a viewer, and never deletes', () => {
    for (const [file, methods] of Object.entries(ROUTES)) {
      ...
      expect(source).toMatch(/@req FR-16[36]/)

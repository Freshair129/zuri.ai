...
const ROUTES = [
  ...
  // @req FR-173, FR-254 — the Documents admission and Knowledge Console surfaces
  // must be warmed with the rest of the Knowledge slot before an e2e test pays
  // its first compile.
  '/knowledge', '/knowledge/documents', '/knowledge/console', '/knowledge/data-pipeline', '/knowledge/candidates',

...
ALTER TABLE "LineConversationJob" ADD COLUMN "memoryDeliveryNextAttemptAt" DATETIME;
ALTER TABLE "LineConversationJob" ADD COLUMN "memoryDeliveryLeaseUntil" DATETIME;

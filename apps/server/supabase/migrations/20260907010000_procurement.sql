...
COMMENT ON TABLE "PurchaseOrder" IS 'FR-164 — a purchase order against a Supplier (PO-YYYYMMDD-NNN); DRAFT → SENT → RECEIVED, SHORT_CLOSED (short-close), CANCELLED; total and received quantities computed on read (ADR-066).';

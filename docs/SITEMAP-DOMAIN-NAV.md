...
2. **Strategy** — `/growth/strategy`: Situation, Objectives, Plans and Scenarios tabs; immutable revisions, independent reviews, decisions and PM preview/receipt sections (FR-153, FR-154).

...
- `ENTERPRISE-API-SURFACE.md` → `features/FR-019-enterprise-api.md` and
  `UX-SINGLE-VS-MULTI-BUSINESS.md` → `features/FR-020-adaptive-shell.md`. Every
...
- The four `docs/ai-system/` files and three `docs/replacement/` files start as

...
| **Date** | 2026-09-05 |
| **Knowledge profile update** | 2026-09-08 — ADR-070 isolated execution; other domains retain their dated snapshot |
...
ADR-070 เพิ่ม durable executor/lineage สำหรับ Stage 1–8 ในระบบทดสอบจากเดิมที่มี pure calculators.
...
| Knowledge ingestion 17 stages | isolated raw-to-published acceptance ผ่านแล้ว; zuri 1–8, passive GKS decisions/gate, GenesisBlock worker physical writes/publication; production ยังแยกงาน | FEAT-013, ADR-070 |

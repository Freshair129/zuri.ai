...
|---|---|---|---|---|
| RSK-001 | วาง tenant ผิดตอน onboarding (แยก tenant แล้วอยากแชร์ CRM ทีหลัง — ย้ายยาก) | M | H | คำถาม onboarding "ใช้ฐานลูกค้าร่วมไหม" ตัดสิน tenant placement (BR-001); เอกสาร `../domains/project-manager/features/FR-020-adaptive-shell.md` |
...
| RSK-003 | Enterprise เอา external ID มาใช้เป็น code ตรง ๆ แล้ว ID ชนข้าม system | M | M | ExternalRef แยก namespace + `labelAs` (`../domains/project-manager/features/FR-019-enterprise-api.md`) |

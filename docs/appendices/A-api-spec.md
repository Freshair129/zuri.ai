...
|---|---|---|---|---|---|
| 1.47.0b | 2026-09-07 | candidate | FR-166/FR-163 (ADR-065): added the Commerce family — `GET/POST /api/commerce/orders`, `GET/PATCH /api/commerce/orders/[id]`, `GET/POST /api/commerce/orders/[id]/payments`, `GET/PATCH /api/commerce/payments/[id]`, `GET /api/commerce/revenue`. Route handler count 181 → 186 | working-tree | Claude Fable 5.1 |

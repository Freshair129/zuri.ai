...
|---|---|---|---|---|---|
| 1.82.0b | 2026-09-16 | candidate | SEC-034 (ADR-093 D6, TASK-ZAI-113): one handler file, `POST /api/crm/customers/[customerId]/chat-evidence/legal-hold` — an OWNER records a dispute reason and an end date deferring a Customer's archive key destruction past a PDPA erasure or the D5 term expiry. Route handler count 288 -> 289 | working-tree | Claude Sonnet 5 |

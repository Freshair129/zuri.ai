...
Version diff 1.22.0b → 1.23.0b (2026-09-06): added `SalesTask` (FR-161, ADR-064 — the legacy Tasks section as a
...
Version diff 1.23.0b → 1.24.0b (2026-09-07): added `SalesOrder`, `SalesOrderLine` and `Payment` (FR-162, FR-163,

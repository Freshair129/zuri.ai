...
- **Tests:** `tests/integration/adaptive-shell.test.js` · `tests/integration/fr072-workspace-mutation-authorization.test.js` · `tests/integration/fr074-scope-creation-authorization.test.js` · `tests/integration/scope-and-isolation.test.js` · `tests/unit/api-access-auth.test.js` · `tests/unit/authorization-seam-routes.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/viewer-authority.test.js` · `tests/unit/viewer-gate.test.js`

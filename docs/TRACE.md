...
- **Tests:** `tests/e2e/fr041-business-first.spec.js` · `tests/e2e/fr059-strategy-edit.spec.js` · `tests/unit/domain-navigation.test.js` · `tests/unit/fr045-api-ui-contract.test.js` · `tests/unit/fr046-api-ui-contract.test.js` · `tests/unit/fr059-strategy-edit-ui.test.js` · `tests/unit/fr060-business-home-read-model.test.js` · `tests/unit/fr060-business-home-visibility.test.js` · `tests/unit/overview-split.test.js` · `tests/unit/people-directory.test.js` · `tests/unit/people-route.test.js` · `tests/unit/people-service.test.js` · `tests/unit/product-readiness-ui.test.js`
...
- **Tests:** `tests/e2e/fr041-business-first.spec.js` · `tests/e2e/smoke.spec.js` · `tests/integration/projects-dashboard.test.js` · `tests/integration/xlsx-intake.test.js` · `tests/unit/domain-navigation.test.js` · `tests/unit/fr045-api-ui-contract.test.js` · `tests/unit/plan-schema.test.js` · `tests/unit/product-readiness-ui.test.js` · `tests/unit/project-list-contract.test.js` · `tests/unit/projects-dashboard-read-model.test.js` · `tests/unit/projects-dashboard-ui.test.js` · `tests/unit/scope-view-context.test.js` · `tests/unit/sidebar-visible-subdomains.test.js` · `tests/unit/topbar-no-dropdown.test.js`
...
### FR-094 — Domain and Feature Readiness Dashboard: an authorized BusinessShell user can open one read-only Platform surface that projects the generated documentation graph into six contextual KPIs, one card per implementation domain, and a complete feature list with domain drilldown. Every projected feature has exactly one primary domain, a concrete use-case example, an evidence-derived progress percentage, a separate ready/not-ready verdict, requirement/code/test evidence and explicit blockers. Progress is calculated from documented declaration (20%), code evidence (40%) and test evidence (40%); readiness never follows the percentage alone. The surface reads the committed generated snapshot, performs no database or network writes, labels its generation time and methodology, and treats missing metadata as a governance failure rather than inventing a value.

- **Status:** done
- **Surface:** `/platform/product-readiness/[domain]` (page) · `/platform/product-readiness` (page)
- **Code:** `src/app/(pm)/platform/product-readiness/[domain]/page.jsx` · `src/app/(pm)/platform/product-readiness/page.jsx` · `src/config/domains.js` · `src/modules/project-manager/application/product-readiness-read-model.js` · `src/modules/project-manager/components/ProductReadinessDashboard.jsx`
- **Follows:** FR-094, NFR-008, SDD-018, docs/domains/project-manager/features/FR-094-domain-feature-readiness-dashboard.md
- **Tests:** `tests/e2e/fr041-business-first.spec.js` · `tests/e2e/product-readiness.spec.js` · `tests/unit/domain-navigation.test.js` · `tests/unit/domain-state.test.js` · `tests/unit/fr045-api-ui-contract.test.js` · `tests/unit/product-readiness-read-model.test.js` · `tests/unit/product-readiness-ui.test.js`

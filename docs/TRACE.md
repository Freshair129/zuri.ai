...
- **Status:** n/a
- **Code:** `src/modules/identity/operator-bootstrap.js` · `src/modules/identity/session-port.js`
- **Follows:** FR-075, SDD-024, SDD-052, SEC-008, SEC-014, SEC-018
- **Tests:** `tests/unit/bootstrap-operator-cli.test.js` · `tests/unit/fr046-session-port.test.js` · `tests/unit/iam-session.test.js` · `tests/unit/operator-bootstrap.test.js` · `tests/unit/platform-grant-migration.test.js`

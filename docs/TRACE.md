...
- **Tests:** `tests/e2e/fr046-entry-contract.spec.js` · `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/business-routing-page.test.js` · `tests/unit/business-routing.test.js` · `tests/unit/fr046-api-ui-contract.test.js` · `tests/unit/onboarding-service.test.js` · `tests/unit/workspace-onboarding-routes.test.js`
...
- **Tests:** `tests/integration/adaptive-shell.test.js` · `tests/integration/fr072-workspace-mutation-authorization.test.js` · `tests/integration/fr074-scope-creation-authorization.test.js` · `tests/integration/scope-and-isolation.test.js` · `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/authorization-seam-routes.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/viewer-authority.test.js` · `tests/unit/viewer-gate.test.js`

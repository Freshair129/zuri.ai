...
- **Tests:** `tests/e2e/fr040-project-work.spec.js` · `tests/e2e/navigation-reachability.spec.js` · `tests/e2e/smoke.spec.js` · `tests/integration/fr072-milestone-gate-authorization.test.js` · `tests/integration/project-core.test.js` · `tests/unit/authorization-seam-list-routes.test.js` · `tests/unit/authorization-seam-routes.test.js` · `tests/unit/global-view-drilldown.test.js` · `tests/unit/global-view-scope-contract.test.js` · `tests/unit/project-execution-backpath.test.js` · `tests/unit/project-roadmap-ui.test.js` · `tests/unit/project-work-route.test.js` · `tests/unit/route-reachability.test.js`
...
- **Tests:** `tests/e2e/navigation-reachability.spec.js` · `tests/e2e/smoke.spec.js` · `tests/unit/command-palette-index.test.js`
...
- **Status:** done
- **Surface:** `/api/docs` (api) · `/api/import/commit` (api) · `/api/import/dry-run` (api) · `/api/resolve` (api)
- **Code:** `src/app/api/docs/route.js` · `src/app/api/import/commit/route.js` · `src/app/api/import/dry-run/route.js` · `src/app/api/resolve/route.js` · `src/modules/project-manager/api-docs/openapi.js` · `src/modules/project-manager/import/external-ref.js` · `src/modules/project-manager/import/plan-import-service.js` · `src/modules/project-manager/import/plan-schema.js`
...
- **Tests:** `tests/e2e/smoke.spec.js` · `tests/integration/enterprise-api-auth.test.js` · `tests/integration/external-ref-import.test.js` · `tests/integration/import-target-authorization.test.js` · `tests/integration/openapi-docs.test.js` · `tests/integration/plan-import-scope.test.js` · `tests/integration/plan-import.test.js` · `tests/integration/project-business-binding.test.js` · `tests/unit/api-access-auth.test.js` · `tests/unit/authorization-seam-routes.test.js` · `tests/unit/plan-schema.test.js` · `tests/unit/plan-status-vocabulary.test.js`
...
- **Tests:** `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/viewer-gate.test.js`
...
- **Follows:** BR-001, BR-004, BR-009, FR-069, NFR-007, SDD-004, SDD-006, SDD-009, SDD-012, SDD-013, SDD-018, SDD-020, SDD-021, SDD-024, SDD-033, SDD-036, SDD-037, SEC-001, SEC-002, SEC-006, SEC-008
...
- **Status:** done
- **Surface:** `/businesses` (page) · `/login` (page) · `/` (page) · `/reset-password` (page) · `/signup` (page)
...
- **Follows:** BR-002, SDD-012, SDD-013, SDD-018, SDD-021, SDD-022, SDD-024, SDD-029, SDD-038, SDD-054, SEC-008, SEC-014
- **Tests:** `tests/e2e/fr044-entry-routing.spec.js` · `tests/e2e/fr046-entry-contract.spec.js` · `tests/e2e/fr104-password-reset-redemption.spec.js` · `tests/e2e/fr120-signup.spec.js` · `tests/e2e/fr124-product-readiness.spec.js` · `tests/e2e/navigation-reachability.spec.js` · `tests/e2e/smoke.spec.js` · `tests/unit/breadcrumb-switcher.test.js` · `tests/unit/business-routing-page.test.js` · `tests/unit/business-routing.test.js` · `tests/unit/business-shell-guard.test.js` · `tests/unit/entry-routing-boundary.test.js` · `tests/unit/entry-surfaces.test.js` · `tests/unit/fr046-api-ui-contract.test.js` · `tests/unit/fr046-auth-route.test.js` · `tests/unit/fr056-landing.test.js` · `tests/unit/fr120-signup-page.test.js` · `tests/unit/password-reset-page.test.js` · `tests/unit/route-reachability.test.js` · `tests/unit/scope-view-context.test.js` · `tests/unit/topbar-no-dropdown.test.js`
...
- **Tests:** `tests/e2e/fr041-business-first.spec.js` · `tests/e2e/fr044-entry-routing.spec.js` · `tests/e2e/fr045-files.spec.js` · `tests/e2e/fr058-file-views.spec.js` · `tests/e2e/fr059-strategy-edit.spec.js` · `tests/e2e/fr060-business-home.spec.js` · `tests/e2e/fr124-product-readiness.spec.js` · `tests/e2e/smoke.spec.js` · `tests/integration/fr072-project-service-authorization.test.js` · `tests/integration/project-business-binding.test.js` · `tests/integration/project-core.test.js` · `tests/unit/business-shell-guard.test.js` · `tests/unit/domain-navigation.test.js` · `tests/unit/fr045-api-ui-contract.test.js` · `tests/unit/fr059-strategy-edit-ui.test.js` · `tests/unit/fr060-business-home-read-model.test.js` · `tests/unit/fr060-business-home-visibility.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr124-product-readiness-read-model.test.js` · `tests/unit/fr124-product-readiness-ui.test.js` · `tests/unit/overview-split.test.js` · `tests/unit/project-list-contract.test.js` · `tests/unit/projects-dashboard-ui.test.js` · `tests/unit/sidebar-visible-subdomains.test.js`
...
- **Tests:** `tests/e2e/fr041-business-first.spec.js` · `tests/e2e/smoke.spec.js` · `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/business-shell-guard.test.js` · `tests/unit/command-palette-index.test.js` · `tests/unit/domain-navigation.test.js` · `tests/unit/fr060-business-home-visibility.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/profile-permission-service.test.js` · `tests/unit/viewer-gate.test.js`
...
- **Follows:** BR-001, BR-009, FR-069, SDD-006, SDD-009, SDD-021, SDD-037, SEC-001, SEC-002, SEC-006, SEC-008
...
- **Status:** done
- **Surface:** `/waiting-room` (page) · `/api/workspace-invites/[id]` (api) · `/api/workspace-invites/accept` (api) · `/api/workspace-invites` (api) · `/api/workspace-memberships` (api)
- **Code:** `src/app/(entry)/waiting-room/page.jsx` · `src/app/api/workspace-invites/[id]/route.js` · `src/app/api/workspace-invites/accept/route.js` · `src/app/api/workspace-invites/route.js` · `src/app/api/workspace-memberships/route.js` · `src/modules/identity/resolve-viewer.js` · `src/modules/identity/workspace-membership-service.js` · `src/modules/project-manager/application/backup-service.js`
- **Follows:** ADR-008 §D4, docs/features/FR-031-viewer-gate.md, BR-008, BR-016, FR-031, SDD-017, SDD-023, SDD-034, SDD-038, SEC-008, SEC-014
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/viewer-gate.test.js` · `tests/unit/workspace-invite-service.test.js` · `tests/unit/workspace-onboarding-routes.test.js`
...
- **Follows:** BR-001, BR-003, BR-004, BR-007, BR-009, FR-069, SDD-002, SDD-006, SDD-009, SDD-021, SDD-037, SEC-001, SEC-002, SEC-006, SEC-008
...
- **Follows:** BR-001, BR-004, BR-007, BR-009, FR-069, FR-070, SDD-002, SDD-006, SDD-009, SDD-021, SDD-037, SDD-039, SEC-001, SEC-002, SEC-006, SEC-008
...
- **Code:** `src/app/api/ingest/documents/route.js` · `src/app/api/mcp/route.js` · `src/app/api/pipelines/runs/[executionRunId]/events/route.js` · `src/app/api/pipelines/runs/[executionRunId]/replay/route.js` · `src/app/api/pipelines/runs/[executionRunId]/route.js` · `src/app/api/pipelines/runs/route.js` · `src/modules/knowledge/ingestion-job.js` · `src/modules/project-manager/mcp/transport.js` · `src/modules/project-manager/views/execution/mode-bodies.jsx` · `src/platform/integrations/core/cloud-sot-agent.js` · `src/platform/integrations/core/document-intake-contract.js` · `src/platform/integrations/core/pipeline-tracking-contract.js` · `src/platform/integrations/core/pipeline-tracking-service.js`
- **Follows:** BR-001, BR-021, FR-071, SDD-042, SDD-057, SDD-066, SDD-067, SDD-073, SEC-001, SEC-003, SEC-008, SEC-021
- **Tests:** `tests/e2e/smoke.spec.js` · `tests/integration/openapi-docs.test.js` · `tests/unit/document-intake-ui.test.js` · `tests/unit/knowledge-ingestion-job.test.js` · `tests/unit/pipeline-mcp-transport.test.js` · `tests/unit/pipeline-monitor-ui.test.js` · `tests/unit/pipeline-tracking-route.test.js` · `tests/unit/platform/cloud-sot-agent.test.js` · `tests/unit/platform/document-intake-contract.test.js` · `tests/unit/platform/knowledge-ingestion-catalog.test.js` · `tests/unit/platform/pipeline-tracking-contract.test.js` · `tests/unit/platform/pipeline-tracking-migration.test.js` · `tests/unit/platform/pipeline-tracking-service.test.js` · `tests/unit/project-manager-mcp.test.js` · `tests/unit/smartgift-document-intake-migration.test.js`
...
- **Tests:** `tests/integration/adaptive-shell.test.js` · `tests/integration/fr072-workspace-mutation-authorization.test.js` · `tests/integration/fr074-scope-creation-authorization.test.js` · `tests/integration/scope-and-isolation.test.js` · `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/api-access-auth.test.js` · `tests/unit/authorization-seam-routes.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/viewer-authority.test.js` · `tests/unit/viewer-gate.test.js`
...
- **Code:** `src/app/api/backup/export/route.js` · `src/app/api/backup/import/route.js` · `src/modules/identity/operator-bootstrap.js` · `src/modules/identity/resolve-viewer.js` · `src/modules/identity/viewer-authority.js` · `src/modules/project-manager/application/backup-service.js` · `src/modules/project-manager/application/scope-service.js`
- **Follows:** ADR-008 §D4, docs/features/FR-031-viewer-gate.md, BR-001, BR-008, FR-031, FR-075, SDD-017, SDD-023, SDD-034, SEC-001, SEC-008, SEC-014
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/fr072-workspace-mutation-authorization.test.js` · `tests/integration/fr074-scope-creation-authorization.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/scope-and-isolation.test.js` · `tests/integration/workspace-onboarding-flow.test.js` · `tests/unit/authorization-seam-routes.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/fr061-per-business-domain-visibility.test.js` · `tests/unit/fr076-product-owner-business-assignment.test.js` · `tests/unit/operator-bootstrap.test.js` · `tests/unit/platform-grant-migration.test.js` · `tests/unit/viewer-authority.test.js` · `tests/unit/viewer-gate.test.js`
...
- **Tests:** `tests/integration/agent-webhook-route.test.js` · `tests/integration/backup.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/fr109-knowledge-ingestion-executor.test.js` · `tests/integration/line-oa-connection-health.test.js` · `tests/integration/line-oa-evidence-convergence.test.js` · `tests/integration/platform/integration-persistence.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/fr079-runtime-cutover.test.js` · `tests/unit/platform/integration-contracts.test.js` · `tests/unit/platform/line-oa-webhook.test.js` · `tests/unit/platform/raw-ingest-service.test.js` · `tests/unit/platform/raw-record-repository-read.test.js`
...
- **Code:** `prisma/seed.js` · `src/app/(pm)/projects/page.jsx` · `src/lib/validation/entities.js` · `src/lib/validation/enums.js` · `src/modules/project-manager/application/project-service.js` · `src/modules/project-manager/components/project-status-options.js` · `src/modules/project-manager/components/ProjectModal.jsx`
- **Follows:** BR-001, BR-004, BR-009, NFR-007, NFR-008, SDD-002, SDD-004, SDD-021, SDD-032, SDD-033, SDD-036, SDD-047, SEC-001, SEC-008
- **Tests:** `tests/e2e/fr041-business-first.spec.js` · `tests/e2e/smoke.spec.js` · `tests/integration/fr072-project-service-authorization.test.js` · `tests/integration/project-business-binding.test.js` · `tests/integration/project-core.test.js` · `tests/integration/xlsx-intake.test.js` · `tests/unit/plan-schema.test.js` · `tests/unit/project-list-contract.test.js` · `tests/unit/project-status-options.test.js` · `tests/unit/projects-dashboard-read-model.test.js` · `tests/unit/projects-dashboard-schema-migration.test.js` · `tests/unit/projects-dashboard-ui.test.js`
...
- **Status:** done
- **Code:** `src/modules/market-intelligence/application/market-observation-service.js` · `src/modules/market-intelligence/application/translate-raw-record.js` · `src/modules/market-intelligence/domain/market-observation.js` · `src/modules/market-intelligence/infrastructure/gks-market-identity-resolver.js` · `src/modules/market-intelligence/infrastructure/market-observation-repository.js` · `src/modules/market-intelligence/infrastructure/market-raw-record-repository.js` · `src/modules/project-manager/application/backup-service.js`
- **Follows:** BR-008, BR-019, SDD-023, SDD-049, SEC-008, SEC-017
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/market-intelligence-persistence.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/market-intelligence-schema-migration.test.js` · `tests/unit/market-intelligence/gks-market-identity-resolver.test.js` · `tests/unit/market-intelligence/market-observation-domain.test.js` · `tests/unit/market-intelligence/market-observation-repository.test.js` · `tests/unit/market-intelligence/market-raw-record-repository.test.js` · `tests/unit/market-intelligence/translate-raw-record.test.js`
...
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/identity-erase.test.js` · `tests/integration/password-reset-flow.test.js` · `tests/unit/auth-service.test.js` · `tests/unit/canonical-iam-migration.test.js` · `tests/unit/canonical-iam-runtime-role-cutover.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/fr046-auth-route.test.js` · `tests/unit/fr046-session-port.test.js` · `tests/unit/iam-session.test.js` · `tests/unit/operator-bootstrap.test.js` · `tests/unit/password-reset-service.test.js`
...
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/sot-decisions-route.test.js` · `tests/unit/api-access-key-migration.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/sot-data-plane-auth.test.js` · `tests/unit/sot-decision-migration.test.js` · `tests/unit/sot-decision-service.test.js` · `tests/unit/sot-inbox-ui.test.js`
...
- **Status:** done
- **Surface:** `/api/auth/reset-password` (api) · `/api/platform/users/password-resets` (api) · `/reset-password` (page)
- **Code:** `src/app/api/auth/reset-password/route.js` · `src/app/api/platform/users/password-resets/route.js` · `src/app/reset-password/page.jsx` · `src/components/forms/PasswordField.jsx` · `src/modules/identity/auth-service.js` · `src/modules/identity/password-reset-copy.js`
- **Follows:** SDD-022, SDD-024, SDD-052, SDD-054, SEC-008, SEC-014, SEC-018
- **Tests:** `tests/e2e/fr104-password-reset-redemption.spec.js` · `tests/integration/password-reset-flow.test.js` · `tests/unit/auth-service.test.js` · `tests/unit/entry-surfaces.test.js` · `tests/unit/fr046-auth-route.test.js` · `tests/unit/iam-session.test.js` · `tests/unit/password-reset-page.test.js` · `tests/unit/password-reset-routes.test.js` · `tests/unit/password-reset-service.test.js`
...
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/enterprise-api-auth.test.js` · `tests/integration/external-ref-import.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/integration/import-target-authorization.test.js` · `tests/integration/openapi-docs.test.js` · `tests/integration/plan-import.test.js` · `tests/integration/project-business-binding.test.js` · `tests/unit/api-access-auth.test.js` · `tests/unit/api-access-key-migration.test.js` · `tests/unit/api-access-key-routes.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/import-authorization.test.js` · `tests/unit/mint-api-access-key-cli.test.js`
...
- **Tests:** `tests/integration/backup.test.js` · `tests/integration/fr075-restore-authorization.test.js` · `tests/unit/bootstrap-operator-cli.test.js` · `tests/unit/fr045-backup-contract.test.js` · `tests/unit/fr046-session-port.test.js` · `tests/unit/fr120-signup-page.test.js` · `tests/unit/iam-session.test.js` · `tests/unit/operator-bootstrap.test.js` · `tests/unit/platform-grant-migration.test.js`
...
- **Feature:** FEAT-012 — ExecutionPlanBundle — one portable, self-contained programme artifact (strategy + N Projects + cross-Project dependencies) imported through one combined dry-run and one confirmation, above the canonical PlanEnvelope
- **Status:** done
- **Surface:** `/api/import/bundle/commit` (api) · `/api/import/bundle/dry-run` (api)
- **Code:** `src/app/api/import/bundle/commit/route.js` · `src/app/api/import/bundle/dry-run/route.js` · `src/modules/project-manager/import/bundle/bundle-commit-service.js` · `src/modules/project-manager/import/bundle/bundle-dry-run.js` · `src/modules/project-manager/import/bundle/bundle-receipt.js` · `src/modules/project-manager/import/bundle/bundle-resolver.js` · `src/modules/project-manager/import/bundle/bundle-schema.js` · `src/modules/project-manager/import/plan-import-service.js`
- **Follows:** BR-001, BR-002, BR-007, BR-009, FR-069, SDD-006, SDD-009, SDD-021, SDD-037, SDD-056, SEC-001, SEC-002, SEC-003, SEC-006, SEC-008
- **Tests:** `tests/integration/execution-plan-bundle.test.js` · `tests/integration/external-ref-import.test.js` · `tests/integration/import-target-authorization.test.js` · `tests/integration/openapi-docs.test.js` · `tests/integration/plan-import.test.js` · `tests/integration/project-business-binding.test.js` · `tests/unit/bundle-schema.test.js`
...
- **Code:** `src/app/api/pipelines/runs/route.js` · `src/modules/knowledge/ingestion-job.js` · `src/platform/integrations/core/knowledge-ingestion-executor.js` · `src/platform/integrations/core/pipeline-tracking-contract.js` · `src/platform/integrations/core/raw-ingest-service.js` · `src/platform/integrations/core/raw-record-repository.js`
- **Follows:** BR-002, BR-021, BR-022, FR-081, SDD-042, SDD-057, SDD-066, SDD-067, SDD-069, SDD-070, SDD-072, SDD-073, SEC-001, SEC-003, SEC-008, SEC-021, docs/domains/integration/features/FR-081-raw-external-ingestion.md
- **Tests:** `tests/integration/fr109-ingestion-run-identity.test.js` · `tests/integration/fr109-knowledge-ingestion-executor.test.js` · `tests/integration/fr119-knowledge-ingestion-quarantine.test.js` · `tests/integration/openapi-docs.test.js` · `tests/integration/platform/integration-persistence.test.js` · `tests/unit/knowledge-chunking.test.js` · `tests/unit/knowledge-entity-extraction.test.js` · `tests/unit/knowledge-ingestion-job.test.js` · `tests/unit/knowledge-stage-runner-trace.test.js` · `tests/unit/knowledge-stage-runner.test.js` · `tests/unit/pipeline-tracking-route.test.js` · `tests/unit/platform/integration-contracts.test.js` · `tests/unit/platform/knowledge-ingestion-catalog.test.js` · `tests/unit/platform/pipeline-tracking-contract.test.js` · `tests/unit/platform/pipeline-tracking-service.test.js` · `tests/unit/platform/raw-ingest-service.test.js` · `tests/unit/platform/raw-record-repository-read.test.js`
...
- **Tests:** `tests/integration/agent-request-envelope.test.js` · `tests/integration/xlsx-intake.test.js` · `tests/unit/agent-requestable-sensitivity.test.js` · `tests/unit/knowledge-classification.test.js` · `tests/unit/knowledge-stage-runner.test.js` · `tests/unit/plan-schema.test.js`
...
- **Follows:** SDD-064
- **Tests:** `tests/unit/knowledge-dedup.test.js` · `tests/unit/knowledge-provenance.test.js` · `tests/unit/knowledge-stage-runner-trace.test.js` · `tests/unit/knowledge-stage-runner.test.js`

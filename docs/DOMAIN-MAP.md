...
| Models owned | InventoryCategory, ProductFamily, Factory, ProductMaster, Product, ProductBundle, ProductBundleItem, ProductLot, SerialUnit, StockMovement |
| Routes owned | 12 (11 api · 1 pages) |
| FRs implemented in lane | FR-154, FR-155 |

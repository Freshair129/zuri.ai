...
| FRs implemented in lane | FR-023, FR-078, FR-091, FR-093, FR-097, FR-103, SEC-005 |
...
| Models owned | ExternalIdentity, IdentityLinkToken, ExternalRef, RoleBinding, PersonCredential, PasswordResetToken, Session, ChannelIdentity, SotDataPlaneKey, ApiAccessKey |
| Routes owned | 3 (1 api · 2 pages) |
| FRs implemented in lane | FR-021, FR-022, FR-031, FR-036, FR-038, FR-046, FR-059, FR-061, FR-062, FR-074, FR-075, FR-076, FR-078, FR-094, FR-095, FR-096, FR-097, FR-098, FR-102, FR-104, FR-106, SDD-034 |
...
| Models owned | IntegrationProvider, IntegrationConnection, IntegrationCredential, IngestionRun, RawExternalRecord, SyncCursor, ExternalEntityRef, DeadLetterRecord, SotDecision |

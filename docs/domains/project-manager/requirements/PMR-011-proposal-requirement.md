...
# PMR-011 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-011 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Self-host model เรียกผ่าน gateway API key ที่ scoped/expiring/revocable; raw serving port เป็น private

## Capability and ownership

- Capability: PMF-07
- Primary owner: integration
- Acceptance family: [PMT-011](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- FR-242; identity key pattern
- Existing canonical FR context: FR-242. These references provide context only; they are not repurposed as PMR-011.

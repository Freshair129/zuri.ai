...
# PMR-004 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-004 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Architecture canvas แสดง directed typed edges พร้อม owner/contract/version; มี table และ keyboard alternative

## Capability and ownership

- Capability: PMF-02
- Primary owner: project-manager
- Acceptance family: [PMT-004](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- FR-007; ADR-085 as peer
- Existing canonical FR context: FR-007. These references provide context only; they are not repurposed as PMR-004.

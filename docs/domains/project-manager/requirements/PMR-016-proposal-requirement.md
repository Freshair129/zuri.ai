...
# PMR-016 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-016 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Progress ใช้ strategy/weights/evidence ของ workstream; usage ไม่ใช่ progress; denominator/unknown แสดงได้

## Capability and ownership

- Capability: PMF-01
- Primary owner: project-manager
- Acceptance family: [PMT-016](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- Progress service; ADR-086

...
# PMR-003 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-003 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Feature view เป็นอีก tab; หนึ่ง feature เชื่อมหลาย domain/FR; work ที่เชื่อมหลาย feature ถูก deduplicate ใน totals

## Capability and ownership

- Capability: PMF-01
- Primary owner: project-manager
- Acceptance family: [PMT-003](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- FEATURES registry, FR-124
- Existing canonical FR context: FR-124. These references provide context only; they are not repurposed as PMR-003.

...
# PMR-006 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-006 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Agent inventory มี immutable approved version, charter, skills, tools, model policy, executor constraints, tests และ lifecycle

## Capability and ownership

- Capability: PMF-04
- Primary owner: project-manager
- Acceptance family: [PMT-006](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

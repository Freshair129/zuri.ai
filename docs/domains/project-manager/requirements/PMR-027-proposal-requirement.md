...
# PMR-027 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-027 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Readiness แยก PLANNED, IMPLEMENTED, VERIFIED, DEPLOYED, ACTIVATED, UNKNOWN; ทุก promotion อ้าง evidence

## Capability and ownership

- Capability: PMF-08
- Primary owner: project-manager
- Acceptance family: [PMT-027](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- FR-124
- Existing canonical FR context: FR-124. These references provide context only; they are not repurposed as PMR-027.

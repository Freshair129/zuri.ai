...
# PMR-018 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-018 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Release แยก environment, build, migration, deploy, activation; promotion ผูก tested SHA และ rollback evidence

## Capability and ownership

- Capability: PMF-10
- Primary owner: project-manager
- Acceptance family: [PMT-018](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

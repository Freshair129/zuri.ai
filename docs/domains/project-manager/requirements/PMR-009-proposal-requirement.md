...
# PMR-009 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-009 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Provider registry แยก provider, connection, deployment, model และ capabilities; probe มีเวลาและ evidence

## Capability and ownership

- Capability: PMF-07
- Primary owner: integration
- Acceptance family: [PMT-009](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- IntegrationProvider; FR-048
- Existing canonical FR context: FR-048. These references provide context only; they are not repurposed as PMR-009.

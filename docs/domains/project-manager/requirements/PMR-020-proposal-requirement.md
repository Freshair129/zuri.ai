...
# PMR-020 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-020 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Trace/usage แยก input/output/cache/reasoning tokens, latency, cost basis และ unknown; ไม่เดาค่าเงินจากจำนวน task

## Capability and ownership

- Capability: PMF-10
- Primary owner: integration
- Acceptance family: [PMT-020](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- FR-239, FR-240 patterns
- Existing canonical FR context: FR-239, FR-240. These references provide context only; they are not repurposed as PMR-020.

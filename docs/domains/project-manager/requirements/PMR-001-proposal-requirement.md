...
# PMR-001 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-001 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

สร้าง Project จาก objective, outcome, scope, owner, dates และ execution modes; import dry-run แสดงผลก่อน atomic commit

## Capability and ownership

- Capability: PMF-01
- Primary owner: project-manager
- Acceptance family: [PMT-001](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- FR-003, FR-069, FR-108
- Existing canonical FR context: FR-003, FR-069, FR-108. These references provide context only; they are not repurposed as PMR-001.

...
# PMR-028 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-028 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Agent/provider/workflow version ผ่าน eval suite ก่อน approve; regression, adversarial scope และ side-effect checks มี threshold

## Capability and ownership

- Capability: PMF-10
- Primary owner: project-manager
- Acceptance family: [PMT-028](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- Existing golden evaluation

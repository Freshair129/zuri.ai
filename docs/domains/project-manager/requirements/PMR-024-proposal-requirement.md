...
# PMR-024 — Proposal requirement

**Version:** 0.1.0b · **Status:** Candidate

> This file is the single local source for the proposal requirement body. PMR-024 is a proposal-local key; it is not a canonical FR and must not be used as an implementation annotation until the requirement is registered.

## Normative behavior

Notification inbox/webhook/subscription ระบุ event filters, recipients, delivery receipts และ retry; ไม่มี auto-send จากการเปิดหน้า

## Capability and ownership

- Capability: PMF-09
- Primary owner: integration
- Acceptance family: [PMT-024](../../../architecture/project-manager-system/07-DELIVERY-AND-VERIFICATION.md#5-acceptance-scenarios)

## Existing repository references

- Existing delivery ports

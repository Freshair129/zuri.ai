...
`MarketObservation` is the first persisted model owned by this domain under #76 and was delivered in PR #88. The remaining names are candidate concepts only until their own global implementation requirements land:

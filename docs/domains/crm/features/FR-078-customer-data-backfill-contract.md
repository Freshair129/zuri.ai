...
- [Contract manifest](../../../../apps/server/contracts/migrations/smartgift-customer-data-contract.json)
- [Duplicate review queue contract v0.3.0B](../../../../apps/server/contracts/migrations/smartgift-customer-review-queue-contract.json)
- [Duplicate review queue contract schema](../../../../apps/server/contracts/migrations/smartgift-customer-review-queue-contract.schema.json)
- [Contract schema](../../../../apps/server/contracts/migrations/smartgift-customer-data-contract.schema.json)
- [Staging record schema](../../../../apps/server/contracts/migrations/smartgift-customer-record.schema.json)
- [Target schema migration](../../../../apps/server/supabase/migrations/20260818070000_customer_profile_backfill_schema.sql)
- [Platform approver profile migration](../../../../apps/server/supabase/migrations/20260818071000_platform_approver_profile.sql)
- [Current contract receipt migration](../../../../apps/server/supabase/migrations/20260818072000_customer_profile_contract_receipt.sql)
- [Duplicate review queue migration](../../../../apps/server/supabase/migrations/20260818073000_customer_import_review_queue.sql)
- [Customer review runtime login migration](../../../../apps/server/supabase/migrations/20260818090201_customer_review_runtime_login.sql)
- [Customer review runtime login provisioning](../../../../apps/server/scripts/provision-customer-review-runtime-login.mjs)
- [Target verification script](../../../../apps/server/scripts/verify-smartgift-customer-profile-target.mjs)
...
- [Platform-owner approval](../../../../apps/server/contracts/approvals/smartgift-customer-data-platform-owner-20260818.json)
- [Customer-data owner and security approval](../../../../apps/server/contracts/approvals/smartgift-customer-data-owner-security-20260818.json)

...
vocabulary in `domain/line-oa-rich-menu.js`; the only writer
`application/line-oa-rich-menu-service.js`; `GET/POST /api/line-oa/rich-menus`
...
|---|---|---|---|---|---|
| 0.6.0b | 2026-09-06 | candidate | Added explicit FEAT-019 phase links and current server/Edge evidence boundaries; no runtime or ownership manifest changes | base 4c0cbe3 | RWANG |

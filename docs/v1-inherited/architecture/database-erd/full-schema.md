...
> Source: `G:/zuri/docs/architecture/database-erd/full-schema.md` @ `0b6d3c3` · imported 2026-08-11
...
erDiagram
    ...
    Product {
        uuid     id                  PK
        string   sku                 UK  "Business key: TVS-[CAT]-[PACK]-[SUBCAT]-[NN]"
        string   barcode                 "External scannable code (EAN-13/UPC) — optional"
        string   name
...
**ADR:** [[ADR-037]] Reuse Product as Course Catalog, [[ADR-042]] SKU Generation, [[ADR-075]] ERP-Standard ID Naming

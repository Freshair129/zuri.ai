...
> Source: `G:/zuri/docs/remediation/patterns/import-unify.md` @ `0b6d3c3` · imported 2026-08-16
...
In each listed file replace the import path only:
  from '@/lib/prisma'  ->  from '@/lib/db'
Named imports stay identical (getPrisma). No other changes.

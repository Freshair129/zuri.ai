...
> Source: `G:/zuri/docs/remediation/patterns/README.md` @ `0b6d3c3` · imported 2026-08-11
...
# Pattern templates for local-pool dispatch
Injected verbatim into worker prompts. Keep each < 400 tokens, v-plain style.
Haiku tasks may also reference these. Author/curate = T3 (Claude/architect).

...
> Source: `G:/zuri/docs/decisions/adrs/ADR-065-industry-plugin-system.md` @ `0b6d3c3` · imported 2026-08-16
...
**Status:** APPROVED
**Date:** 2026-03-30
**Updated:** 2026-04-09 (Sync with ADR-068 roles)
...
export default {
  ...
  navigation: [
    { label: 'Kitchen',    icon: 'ChefHat',   path: '/kitchen',    roles: ['MANAGER', 'STAFF'] },

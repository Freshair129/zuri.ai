...
> Source: `G:/zuri/docs/product/specs/FEAT18-EXPRESS-INTEGRATION.md` @ `0b6d3c3` · imported 2026-08-11
...
**Reviewer:** —
**Depends On:** FEAT17 (FlowAccount API layer)
**Related:** FEAT03 (Invoice/Order source)

...
| **Author** | Claude |
| **Date** | 2026-08-15 |
| **Relates to** | [ARCHITECTURE.md](ARCHITECTURE.md), [PRODUCT-V2.md](PRODUCT-V2.md), [ADR-003](ADR-003-V2-REPLACES-V1-BY-REUSE.md), [ADR-007](ADR-007-LINE-AI-STACK-SEQUENCING.md), [ADR-016](ADR-016-SQLITE-AUTHORITY-AND-MANAGED-LOCAL-FILE-WORKSPACE.md), [ADR-018](ADR-018-SUPABASE-PRODUCTION-TENANT-ISOLATION.md), BR-007, BR-009, BR-010, BR-011, SDD-009, FR-012, FR-019, FR-027, FR-030, FR-045, FR-047…FR-050 |

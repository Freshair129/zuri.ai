...
| W1 | A2 isolation/backup inventory | M | yes | BLOCKED | probe contract corrected; prerequisites approved |
...
| W2 | A5 real evaluation + live rollback-only isolation | L | yes, when gates exist | NOT_RUN | both PASS and fresh |

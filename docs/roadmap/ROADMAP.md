...
> Revision 2.117.0b (2026-09-20): reconcile TASK-ZAI-112 after PR #429 and its follow-up reached `origin/main`. The retrieval implementation is merged as `be7bdf6a722dd249efacc8e6c9e4f6cdb2e65af7`; the follow-up chain-integrity refusal is merged as `c1d59c1227695e805d67eda763fec95c710ee563`. The follow-up records 706 files / 5,883 tests passed, a clean build and `npm run govern` with 0 CRITICAL. All three task-container criteria are checked; proof remains HOSTED_CI / MERGED and production activation is NOT_RUN.
...
| TASK-ZAI-094 | PHASE-ZAI-LINE-OA-PLATFORM | task | Grounding isolated acceptance — four-process harness, citations on the job trace, zero cross-tenant leakage, worker-stopped reply, MSP spawn cost measured | P0 | Claude | planned (SPR-ZAI-05) | TASK-ZAI-093 | ../roadmap/ROADMAP-zuri-ai-24w-program.md |
...
| TASK-ZAI-112 | SPR-ZAI-05 | Chat evidence retrieval, FR-245 — an OWNER at AAL2 retrieves one Customer's archived messages for a date range by session with a case reference, as an export carrying file and manifest hashes, audited | done | HOSTED_CI | MERGED | TASK-ZAI-111 | ROADMAP.md | PR #429 merged as be7bdf6a722dd249efacc8e6c9e4f6cdb2e65af7; follow-up c1d59c1227695e805d67eda763fec95c710ee563 merged; npm test 706 files / 5,883 tests passed; npm run build clean; npm run govern 0 CRITICAL; acceptance/success/exit criteria checked; production activation NOT_RUN |

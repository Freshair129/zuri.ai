...
| TASK-ZAI-047 | SPR-ZAI-03 | task | Knowledge base console: source library, ingestion run status, corpus and generation registry, cited query | P0 | Codex | review | TASK-ZAI-045 | Section 3.1 row 4; FR-253, FR-173, FR-071, FR-110 |
...
| 0.4.6 | 2026-09-17 | TASK-ZAI-047 / FR-253 implemented under its owner-approved Console specification and moved to review with local Server, browser, native pipeline and build evidence. Corpus queries and immutable artifacts reuse existing authorities; no schema or GKS contract change. SPR-ZAI-03 progress 0 to 7 and PHASE-ZAI-02 0 to 5, recomputed from task statuses. Production deployment and activation remain separate; phase report records full regression outcomes. |

...
| TASK-FR-041-042 | PHASE-V2-REPLACE | task | Business-first Overview with Business Strategy Roadmap/Goals and HR / People peer domain | P0 | Codex | done | FR-035; FR-039; ADR-013 | features/FR-041-business-strategy-overview.md; features/FR-042-hr-people-peer-domain.md |
...
| TASK-FR-057 | PHASE-V2-REPLACE | task | Multi-tenant principal-scoped MSP vaults, per-turn AuthContext and policy-before-retrieval | P0 | ATHER | in-progress | FR-021..029; FR-051..052 | ADR-022; features/FR-057-authorized-agent-context-and-vault-resolution.md; roadmap/PLAN-FR-057-AUTHORIZED-AGENT-CONTEXT.md |

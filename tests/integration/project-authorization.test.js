...
describe('FR-072 project authorization', () => {
  beforeAll(async () => {
    ...
    // Moved ahead of the fixture builds below: Wave 1 (FR-072) now guards
    // createProject/createWorkstream, so the fixtures this Wave 0 suite builds
    // with them need an authorized viewer. Narrow fix to this file's own call
    // sites only, reported per route-viewer-design.md §5's residual-risk clause.
    ...
    // instead of going through the now-guarded service.

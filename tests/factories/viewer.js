...
export function makeViewer(over = {}) {
  ...
  for (const [name, value] of Object.entries({ visibleBusinessIds, ownedBusinessIds, visibleDomains, ownedTenantIds })) {
  ...
  return {
    ...
    domainsByBusinessId: domains, visibleDomains, isPlatform, isOperator,
  }
}
